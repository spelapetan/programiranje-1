...
let euro_to_dollar (Euro x) = Dollar (x *. 1.145279)

let dollar_to_euro (Dollar x) = Euro (x *. 0.873100134)
...
let to_pound = function
  | Yen x -> Pound (0.00721543439 *. x)
  | Krona x -> Pound (0.0879640681 *. x)
  | Pound x -> Pound x
...
let rec intbool_separate ib_ist = 
