...
type spell = Blaze | Firewall | Resurrect | Cripple | Renounce | Banish
...
let frodo =  {name = "Frodo"; ability = 53; hp = 1000; skills = [Renounce]; race = Hobit}
let ajitam = {name = "Ajitam";   ability = 1337; hp = 7331; skills = [Firewall; Resurrect; Firewall];  race = Hobit}
...
let snoop_dogg = {name = "Snoop Dog";   ability = 420; hp = 4000; skills = [Blaze];  race = Orc}
